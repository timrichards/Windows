...
{
    class LVitem_MountedVM : ListViewItemVM_Base, IListUpdater
    {
        ...
        LVitem_MountedVM(LVitemProject_Updater<bool> lvItemProject_Updater)
        {
            LVitemProject_Updater = lvItemProject_Updater;
        }

        internal LVitem_MountedVM(LVitemProject_Updater<bool> lvItemProject_Updater, PathBuilder directory)
        ...
        internal LVitem_MountedVM(LVitemProject_Updater<bool> lvItemProject_Updater, LocalTreeNode folder)
            : this(lvItemProject_Updater)
        {
            _datum = folder;
        }
