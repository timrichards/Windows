...
namespace DoubleFile
{
  ...
  //  [System.ComponentModel.DesignerCategory("Code")]
    partial class FormSearchDirLists : Form
    {
            System.Windows.Window m_ownerWindow = null;
            IEnumerable<LVitem_ProjectVM> ListLVvolStrings { get; set; }

            internal FormSearchDirLists(System.Windows.Window ownerWindow, IEnumerable<LVitem_ProjectVM> listLVvolStrings)
                : this()
            {
            ...
            static internal void RestartTreeTimer(FormSearchDirLists form1, IEnumerable<LVitem_ProjectVM> listLVvolStrings)
            {
                if (form1 != null)
                {
    ...
    partial class GlobalDataSDL : UtilAnalysis_DirList
    {
        internal static FormSearchDirLists static_form { get; private set; }
        internal static GlobalDataSDL GetInstance(FormSearchDirLists form) { static_instance = new GlobalDataSDL(form); return static_instance; }
        GlobalDataSDL(FormSearchDirLists form)
        {
            static_form = form; 
            ClearMem_Form1();
        }
