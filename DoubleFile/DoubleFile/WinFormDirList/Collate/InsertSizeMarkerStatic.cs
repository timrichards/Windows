    ...
    partial class Collate
    {
        static class InsertSizeMarkerStatic
        {
            internal static void Go(List<ListViewItem> listLVitems, int nIx, bool bUnique, bool bAdd = false)
            {
                ...
                lvItem.Text = ((UtilDirList.FormatSize(((NodeDatum)((TreeNode)(bUnique ? listLVitems[nIx].Tag : ((KeyList<TreeNode>)listLVitems[nIx].Tag)[0])).Tag).TotalLength, bNoDecimal: true)));
